...
class Privacy extends Component {
  render() {
    return (
      <section className="about bg-primary text-center" id="privacy">

      <h1>Privacy Policy of the CougarBot Facebook app</h1>
      <p>Effective date: July 09, 2018</p>
               ...
               <div>
                   ...
                   <p>120 Bloomfield Ave, Caldwell, NJ 07006, USA,</p>

                   <p>bkarki@caldwell.edu</p>
